...
var serviceAccount = {
  ...
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/macbook-iot-client%40oamk-iot-powerbox.iam.gserviceaccount.com"
};
...
async function configUpdate(change, context) {
  ...
  if (context) {
    ...
    var devicePath = `projects/${projectId}/locations/${gcpLocation}/registries/${registryId}/devices/${context.params.deviceId}`;    console.log(change.after.data());
